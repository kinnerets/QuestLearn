...
const IDENTITY_CARDS = ['אומץ', 'יצירתיות', 'חברוּת אמיתית', 'סקרנוּת', 'מנהיגוּת'];

const COACH: Record<string, string[]> = {
  reflection: [
    'חותמת נהדרת. בונים את מי שנהיים - צעד קטן בכל פעם.',
  ...
  budget: [
    ...
    'ניהלת את הזמן שלך במקום שהוא ינהל אותך. זו מנהיגות.',
  ],
  scenario: [
    ...
    <main className="app-shell">
      <div className="screen-body compass">
        <div className="compass-head">
          ...
          <div>
            <h1>אי המצפן</h1>
            <p>ארבעה עולמות של מנהיגות - כאן אין תשובה נכונה, יש רק את מי שנהיים.</p>
          </div>
        </div>
